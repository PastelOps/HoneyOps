...
const (
	...
	ubuntuOwnerID    string = "099720109477"
	windowsOwnerId   string = "801119661308"
)

func (a *AwsPulumiDeployer) SearchAMI(ctx *pulumi.Context) (err error) {

	fmt.Println(GetAMIByName(ctx, "ubuntu*", nil, nil))
...
func GetAMIByName(ctx *pulumi.Context,
	...
	owners := []string{awsOwnerID, redhatOwnerID, amazonOwnerAlias, ubuntuOwnerID, windowsOwnerId}
